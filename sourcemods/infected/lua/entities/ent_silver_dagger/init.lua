...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/morrowind/silver/dagger/m_throwsilver.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("mad_morrowind_chitin_dagger") == NULL then
			activator:Give("mad_morrowind_chitin_dagger")
		else
