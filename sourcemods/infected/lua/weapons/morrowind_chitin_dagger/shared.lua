...
SWEP.Instructions	= "Chitin daggers are created from the laminated shells of creatures to produce strong but flexible weapons, typically serrated to create a more damaging edge."
...
SWEP.ViewModel      = "models/morrowind/chitin/dagger/v_chitindagger.mdl"
SWEP.WorldModel   = "models/morrowind/chitin/dagger/w_chitindagger.mdl"
...
function SWEP:SecondaryAttack()
	...
	if (SERVER) then
		local knife = ents.Create("ent_chitin_dagger")
