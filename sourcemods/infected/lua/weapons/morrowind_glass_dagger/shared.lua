...
SWEP.Instructions	= "Glass daggers are created using rare metals and volcanic glass to produce blades of virtually unparalleled sharpness."
...
SWEP.ViewModel      = "models/morrowind/glass/dagger/v_glassdagger.mdl"
SWEP.WorldModel   = "models/morrowind/glass/dagger/w_glassdagger.mdl"
...
function SWEP:SecondaryAttack()
	...
	if (SERVER) then
		local knife = ents.Create("ent_glass_dagger")
