...
SWEP.Instructions	= "Glass knifes are created using rare metals and volcanic glass to produce blades of virtually unparalleled sharpness."
...
SWEP.ViewModel      = "models/morrowind/glass/knife/v_glassknife.mdl"
SWEP.WorldModel   = "models/morrowind/glass/knife/w_glassknife.mdl"
...
function SWEP:SecondaryAttack()
	...
	if (SERVER) then
		local knife = ents.Create("ent_glass_knife")
