...
SWEP.Instructions	= "Iron knifes are created using one of the the most abundant and cheap materials available for the construction of weapons and heavy armor in Morrowind and the rest of Tamriel."
...
function SWEP:SecondaryAttack()
	...
	if (SERVER) then
		local knife = ents.Create("ent_iron_knife")
