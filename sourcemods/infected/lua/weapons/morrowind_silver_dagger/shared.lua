...
SWEP.Instructions	= "Silver is typically used to enhance the appearance of the item or to increase its effectiveness against certain creatures, such as Undead or Werewolves. Solid silver is generally not used due to its high price and low strength, but is instead plated onto another, cheaper metal (such as steel)."
...
function SWEP:SecondaryAttack()
	...
	if (SERVER) then
		local knife = ents.Create("ent_silver_dagger")
