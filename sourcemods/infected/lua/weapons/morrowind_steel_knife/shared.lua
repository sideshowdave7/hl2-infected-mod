...
SWEP.Instructions	= "A steel knife is made from a refined form of iron, which is another of the more common metals used to produce weapons and heavy armor. Its hardness is greater than that of iron, which leads to higher quality items with about the same weight. Steel is the choice of the common soldier and mercenary who cannot afford some of the higher quality materials."
...
function SWEP:SecondaryAttack()
	...
	if (SERVER) then
		local knife = ents.Create("ent_steel_knife")
